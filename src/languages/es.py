...
TEXTS_ES = Texts(
    ...
    ticket_unspammed="Eliminado del spam",
    spam_confirm_only_spam="🗑 Marcar solo como spam (sin bloquear)",
    spam_confirm_spam_and_block="⛔ Marcar como spam + bloquear usuario",
    spam_confirm_cancel="↩️ Cancelar",
